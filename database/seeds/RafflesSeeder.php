...
class RafflesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($raffles as $raffle) {
            ...
            $raffle->addMediaFromUrl(env('APP_URL').'/pics/common/rsample_'.$imgnum[0].'.jpg')->toMediaCollection('raffles','raffles');
            $raffle->addMediaFromUrl(env('APP_URL').'/pics/common/rsample_'.$imgnum[1].'.jpg')->toMediaCollection('raffles','raffles');
            $raffle->addMediaFromUrl(env('APP_URL').'/pics/common/rsample_'.$imgnum[2].'.jpg')->toMediaCollection('raffles','raffles');
