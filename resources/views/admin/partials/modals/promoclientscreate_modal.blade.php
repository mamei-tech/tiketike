<div class="modal fade login" id="mdal_createPromoClient" style="display: none;" aria-hidden="true">
    ...
    <div class="modal-dialog animated">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"> Add Promo Client </h4>
            </div>
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div id="frm_createPromoClient" class="col-md-12">
                        @include('admin.partials.forms.promoclientscreate_form')
