<div class="modal fade login" id="mdal_editPromoClient" style="display: none;" aria-hidden="true">
    ...
    <div class="modal-dialog animated">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"> Edit Promo Client </h4>
            </div>
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div id="frm_editPromoClient" class="col-md-12">
                        @include('admin.partials.forms.promoclientsedit_form')
