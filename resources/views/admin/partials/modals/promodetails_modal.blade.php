<div class="modal fade login" id="mdal_detailsPromo" style="display: none;" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div id="frm_detailsPromo" class="col-md-12">
                        @include('admin.partials.forms.promodetails_form')
