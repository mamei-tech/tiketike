<form  class="form-horizontal" method="post" action="{{ route('promos.store')}}"
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group basicmodal">
                ...
                <select id="slt_client" class="selectpicker" name="client" data-style="btn btn-neutral btn-round"
                        title="Client" tabindex="-98">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group basicmodal">
                ...
                <input id="tb_alt" class="form-control" type="text" name="alternative" placeholder="alternative text for image"/>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group basicmodal">
                ...
                <input id="tb_website" class="form-control" type="text" name="website" placeholder="enter the web for the promo bussines.com"/>
            </div>
        </div>
