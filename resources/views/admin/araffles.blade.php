...
@section('adminview', 'Raffles Manager')
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title"> Anulled </h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    @include('admin.partials.tables.araffle_table')
                    {{ $raffles->links() }}
                </div>
            </div>
        </div>
...
@section('footerScripts')
    ...
    <script src="{{ asset('js/admin/araffles.js') }}" defer></script>
@endsection
