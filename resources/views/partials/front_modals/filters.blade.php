<div class="hidden-lg hidden-md visible-xs">
    <div class="floating-menu">
        <a data-toggle="modal" href="#myModal" class="btn bg-categoriasR" id="categoriesR"></a>
        <a data-toggle="modal" href="#myModalFiltrar" class="btn bg-filtersR" id="filtersR"></a>
        <a href="#3" class="btn bg-priceR" id="priceR"></a>
        <a href="#4" class="btn bg-percentR" id="percentR"></a>
    </div>
</div>
                                    ...
                                    <div id="collapseR{{ $continent->id }}" class="panel-collapse collapse">
                                        @foreach($continent->countries as $country)
                                            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-{{strlen($country->name) > 20?'12':'6'}}"
                                                ...
                                                <input class="right" data-value = {{ $country->id }} type="checkbox" name="countries"
                                                       id="countries">
                                            </div>
                                        @endforeach
                                    </div>
