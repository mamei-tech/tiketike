...
return [
    ...
    'icons' =>  [
         ...
         */
        'all'       => 'now-ui-icons design_bullet-list-67',
        'emergency' => 'now-ui-icons health_ambulance',
        'alert'     => 'now-ui-icons ui-1_bell-53',
        'critical'  => 'now-ui-icons media-2_sound-wave',
        'error'     => 'now-ui-icons ui-1_simple-remove',
        'warning'   => 'fa fa-fw fa-exclamation-triangle', // http://fontawesome.io/icon/exclamation-triangle/
        'notice'    => 'now-ui-icons business_bulb-63',
        'info'      => 'now-ui-icons travel_info',
        'debug'     => 'now-ui-icons objects_support-17',
    ],
